...
recorder.onstop = async () => {
  ...
  /*
   * Check whether meaningful voice activity
   * was detected in this audio chunk.
   *
   * If there is no voice, do NOT send the
   * audio to the AI classifier.
   */
  if (!voiceActivityRef.current) {
    setVoiceVerdict("NO VOICE DETECTED");
    setVoiceConfidence(0);
    setVoiceAnalyzing(false);

    /*
     * Keep the risk assessment neutral
     * while there is no speech.
     */
    setRiskLevel("LOW");
    setThreats([]);
  } else {
    ...
    /*
     * Voice detected → send audio to
     * the AI voice classifier.
     */
  ...
  /*
   * Reset voice activity state before
   * starting the next 3-second chunk.
   */
  voiceActivityRef.current = false;
  setVoiceDetected(false);
          ...
          <div className="analysis-card">
            ...
            <div className="analysis-row">
              ...
              <div>
               ...
               <small>
                 {voiceVerdict === "NO VOICE DETECTED"
                   ? "No meaningful voice activity"
                   : voiceVerdict
